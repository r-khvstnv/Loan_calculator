...
class CreditDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedCreditType = intent.getStringExtra("LoanType")
            ...
            if (binding.etAmount.text.trim().isNotEmpty() &&
                ...
                when(binding.tvSelectedCreditType.text){
                    ...
                    resources.getString(R.string.st_proportional) -> {
                        Toast.makeText(this, "Don't exist", Toast.LENGTH_LONG).show()
                    }
                }
                ...
                //binding.scrollView.scrollTo(0, binding.llResultTable.bottom)
